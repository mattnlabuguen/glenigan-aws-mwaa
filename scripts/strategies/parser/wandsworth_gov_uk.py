...
from glenigan_aws_mwaa.scripts.strategies.parser.parser import ParsingStrategy
from glenigan_aws_mwaa.scripts.strategies.parser.defaults import Defaults
    ...
    def parse(self, raw_data_list: list):
        ...
        for raw_data in raw_data_list:
            ...
            if 'main_details_data' in raw_data and raw_data['main_details_data']:
                ...
                #     logging.info(f'Skipping Application Number: {application_number}')
                #     continue
